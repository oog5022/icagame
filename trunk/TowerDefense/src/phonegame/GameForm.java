...
public final class GameForm
{
     ...
     * @param image
     *                the image that you wnat to display
     * @return the ID of the newly inserted image. You need this number if you want to delete the textbox.
     */
    public final int addImage(String label, Image image)
    {
