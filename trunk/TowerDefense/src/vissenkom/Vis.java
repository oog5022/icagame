...
public class Vis extends GamePlayer
{
    ...
    public Vis(Vissenkom thegame)
    {
        points = 0;
        mygame = thegame;
        setImage("/res/images/fish.png", 36, 22);
        setPosition(250, 250);
    }
     ...
     * zetten.)
     * 
     * @see phonegame.GameItem#animate()
     */
    ...
    /**
     * Negen knopjes-afhandelaars. Ze moeten er alle negen staan, maar ze hoeven niks te doen.
     */
     ...
     * NB deze lege methode mag ook weggelaten worden!
     */
